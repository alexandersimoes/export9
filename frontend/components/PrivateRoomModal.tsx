                    ...
                    >
                      <div className="flex justify-between items-start">
                        ...
                        <div className="flex gap-2">
                          <button
                            onClick={() => copyToClipboard(`https://oec.world/en/games/export-holdem/?room=${room.room_code}`, room.room_code)}
                      ...
                      <div className="mt-3 pt-3 border-t border-opacity-10" style={{ borderColor: 'var(--poker-strong-bg)' }}>
                        <p className="text-sm opacity-70" style={{ color: 'var(--poker-dark-text)' }}>
                          Share this link with your friends: <code className="bg-gray-100 px-1 rounded text-xs">https://oec.world/en/games/export-holdem/?room={room.room_code}</code>
                        </p>
                      </div>
                    </div>
                  ))}
